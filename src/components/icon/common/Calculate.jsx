...
export const PlusIcon = ({ width = 18, height = 18, strokeColor = 'currentColor', ...props }) => {
  return (
    <svg
      width={width}
      height={height}
...
export const PlusInputIcon = ({ width = 14, height = 14, ...props }) => {
  return (
...
export const MinusInputIcon = ({ width = 14, height = 2, ...props }) => {
  return (
    <svg width="14" height="2" viewBox="0 0 14 2" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
